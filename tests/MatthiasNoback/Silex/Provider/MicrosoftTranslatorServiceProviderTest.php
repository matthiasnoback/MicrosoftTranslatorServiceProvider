...
class MicrosoftTranslatorServiceProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDefinesTranslatorAndBrowserWithCachedCurlClientUsingArrayCache()
    {
        $app = new Application();
        ...
        $this->assertInstanceOf('Buzz\Client\Curl', $app['microsoft_translator.browser.real_client']);
    ...
    public function testDefinesAccessTokenProviderWithAccessTokenCacheUsingArrayCache()
    {
        ...
        $this->assertInstanceOf('Buzz\Client\Curl', $app['microsoft_oauth.access_token_provider.browser.client']);
